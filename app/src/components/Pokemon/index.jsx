...
const Pokemon = () => {
  ...
  useEffect(() => {
    const loadPokemonData = async () => {
      ...
      await api
        .get(`pokemon-species/${pokemonIndex}`)
        .then((response) => {
          const {
            flavor_text_entries,
            gender_rate,
  ...
  return isLoading ? (
    ...
    <div className="col-12 fadeIn">
      <h1 className="text-center text-uppercase Section-Heading mt-5 border ">
        {pokemon.name}
      </h1>
      ...
      >
        <div className="col-sm-3 col-md-4 bioDiv d-flex flex-wrap justify-content-center">
          <div className="inner">
        ...
        <div className="col-sm-6 col-md-4 d-flex flex-wrap align-items-center">
        ...
        <div className="col-sm-3 col-md-4 statDiv my-auto mx-auto d-flex flex-wrap justify-content-center">
          <div className="inner">
            <table className="table table-borderless">
              <tbody>
